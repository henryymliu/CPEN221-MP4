...
public final class Util {
    ...
    /**
     * Returns a random empty Location to move to in the specified World that is
     * adjacent to <code>loc</code>, or null if there is no empty adjacent
     * location to move to.
     *
     * @param world
     *            the current World
     * @param loc
     *            the center location, all empty locations to move to returned
     *            (if any) are adjacent to loc
     * @return empty adjacent location to move to, or null if none exists
     */
